...
CREATE TABLE `t_an_ques_answer_detail` (
  ...
  `answer_name` varchar(2048) DEFAULT NULL COMMENT '问题答案名称',
...
CREATE TABLE `t_an_ques_survey` (
  ...
  `ques_survey_name` varchar(2048) NOT NULL COMMENT '问卷名称',
  `ques_survey_english_name` varchar(2048) DEFAULT NULL,
  `ques_survey_logo_url` varchar(2048) DEFAULT NULL COMMENT '问卷logo URL',
  `ques_survey_title` varchar(2048) DEFAULT NULL COMMENT '问卷标题',
...
CREATE TABLE `t_an_ques_survey_answered_detail` (
  ...
  `ques_survey_id` bigint(20) NOT NULL COMMENT '所属问卷ID',
  `ques_survey_name` varchar(2048) DEFAULT NULL COMMENT '问卷名称',
  `ques_type_id` bigint(20) DEFAULT NULL COMMENT '所属题目大类ID',
  `ques_type_name` varchar(2048) DEFAULT NULL COMMENT '题目大类名称',
  `ques_id` bigint(20) NOT NULL COMMENT '题目ID',
  `ques_name` varchar(2048) NOT NULL COMMENT '题目名称',
  `ques_type` int(11) NOT NULL COMMENT '题目类型 1：单选，2：多选，3：填空',
  `answer_id` bigint(20) DEFAULT NULL COMMENT '答案ID',
  `answer_name` varchar(2048) DEFAULT NULL COMMENT '答案内容',
...
CREATE TABLE `t_an_ques_type` (
  ...
  `ques_type_name` varchar(2048) NOT NULL COMMENT '题目大类名称',
  `ques_type_english_name` varchar(2048) DEFAULT NULL,
  `ques_type_remarks` varchar(2048) DEFAULT NULL,
  `ques_survey_id` bigint(20) NOT NULL COMMENT '所属问卷ID',
  `order_by_id` int(11) DEFAULT NULL COMMENT '排序',
